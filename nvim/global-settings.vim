...
set updatetime=500                  "If this many milliseconds nothing is typed the swap file will be written to disk
...
set listchars=tab:▶\ ,trail:.           " Set character to sow in TAB and trail
